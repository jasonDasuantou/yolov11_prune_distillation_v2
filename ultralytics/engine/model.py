...
class Model(nn.Module):
    ...
    def train(
        ...
        **kwargs,
        ...
        # dis, loss_type = None, None
        # if "Distillation" in args:
        #     dis = args["Distillation"]
        #     loss_type = args["loss_type"]
        #     del args["Distillation"]
        #     del args["loss_type"]
        ...
        # if dis is not None:
        #     self.trainer.args["Distillation"] = dis
        #     self.trainer.args["loss_type"] = loss_type
